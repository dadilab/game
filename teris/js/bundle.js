 ...
 */
        function(e) {
            var t, n, r, i, o, s, a, u, c, l, f, p, d, h, g, y, v, m, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0, C = 0, S = ue(), E = ue(), k = ue(), D = ue(), j = function(e, t) {
                return e === t && (f = !0),
                0
            }, A = {}.hasOwnProperty, N = [], _ = N.pop, q = N.push, P = N.push, L = N.slice, O = function(e, t) {
                for (var n = 0, r = e.length; n < r; n++)
                    if (e[n] === t)
                        return n;
                return -1
            }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", M = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", I = "\\[" + R + "*(" + M + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + M + "))|)" + R + "*\\]", W = ":(" + M + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + I + ")*)|.*)\\)|)", B = new RegExp(R + "+","g"), F = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), $ = new RegExp("^" + R + "*," + R + "*"), z = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), U = new RegExp(R + "|>"), X = new RegExp(W), G = new RegExp("^" + M + "$"), V = {
                ID: new RegExp("^#(" + M + ")"),
                CLASS: new RegExp("^\\.(" + M + ")"),
                TAG: new RegExp("^(" + M + "|[*])"),
                ATTR: new RegExp("^" + I),
            ...
            try {
                P.apply(N = L.call(w.childNodes), w.childNodes),
            ...
            function ae(e, t, r, i) {
                var o, a, c, l, f, h, v, m = t && t.ownerDocument, w = t ? t.nodeType : 9;
                if (r = r || [],
                ...
                g)) {
                        ...
                        if (o = f[1]) {
                            if (9 === w) {
                                ...
                                if (c.id === o)
                                    return r.push(c),
                                    r
                            } else if (m && (c = m.getElementById(o)) && x(t, c) && c.id === o)
                                return r.push(c),
                                r
                        } else {
                            if (f[2])
                    ...
                    if (n.qsa && !D[e + " "] && (!y || !y.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                        if (v = e,
                        m = t,
                        1 === w && (U.test(e) || z.test(e))) {
                            for ((m = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((l = t.getAttribute("id")) ? l = l.replace(re, ie) : t.setAttribute("id", l = b)),
                            a = (h = s(e)).length; a--; )
                                h[a] = (l ? "#" + l : ":scope") + " " + xe(h[a]);
                            v = h.join(",")
                        }
                        try {
                            return P.apply(r, m.querySelectorAll(v)),
                            r
                        } catch (t) {
                            D(e, !0)
                        } finally {
            ...
            p = ae.setDocument = function(e) {
                ...
                (n.qsa = K.test(d.querySelectorAll)) && (le((function(e) {
                    ...
                    e.querySelectorAll("[selected]").length || y.push("\\[" + R + "*(?:value|" + H + ")"),
                ...
                : function(e, t) {
                    ...
                    if (!i || !o)
                        return e == d ? -1 : t == d ? 1 : i ? -1 : o ? 1 : l ? O(l, e) - O(l, t) : 0;
                    if (i === o)
                        return pe(e, t);
            ...
            ae.matchesSelector = function(e, t) {
                if (p(e),
                n.matchesSelector && g && !D[t + " "] && (!v || !v.test(t)) && (!y || !y.test(t)))
                    try {
                        var r = m.call(e, t);
            ...
            (r = ae.selectors = {
                ...
                filter: {
                    ...
                    CHILD: function(e, t, n, r, i) {
                        ...
                        : function(t, n, u) {
                            var c, l, f, p, d, h, g = o !== s ? "nextSibling" : "previousSibling", y = t.parentNode, v = a && t.nodeName.toLowerCase(), m = !u && !a, x = !1;
                            if (y) {
                                if (o) {
                                    for (; g; ) {
                                        for (p = t; p = p[g]; )
                                ...
                                if (h = [s ? y.firstChild : y.lastChild],
                                s && m) {
                                    for (x = (d = (c = (l = (f = (p = y)[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2],
                                    p = d && y.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop(); )
                                        if (1 === p.nodeType && ++x && p === t) {
                                            l[e] = [T, d, x];
                                            break
                                        }
                                } else if (m && (x = d = (c = (l = (f = (p = t)[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && c[1]),
                                !1 === x)
                                    for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (m && ((l = (f = p[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [T, x]),
                                    p !== t)); )
                                        ;
            ...
            function Ce(e, t, n, r, i, o) {
                ...
                i && !i[b] && (i = Ce(i, o)),
                ce((function(o, s, a, u) {
                    var c, l, f, p = [], d = [], h = s.length, g = o || function(e, t, n) {
                        for (var r = 0, i = t.length; r < i; r++)
                            ae(e, t[r], n);
                        return n
                    }(t || "*", a.nodeType ? [a] : a, []), y = !e || !o && t ? g : Te(g, p, e, a, u), v = n ? i || (o ? e : h || r) ? [] : s : y;
                    if (n && n(y, v, a, u),
                    r)
                        for (c = Te(v, d),
                        r(c, [], a, u),
                    ...
                    if (o) {
                        if (i || e) {
                            ...
                            for (l = v.length; l--; )
                                (f = v[l]) && (c = i ? O(o, f) : p[l]) > -1 && (o[c] = !(s[c] = f))
                        }
                    } else
                    ...
                    if (n = r.relative[e[u].type])
                        ...
                        if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
                            ...
                            return Ce(u > 1 && we(p), u > 1 && xe(e.slice(0, u - 1).concat({
                                value: " " === e[u - 2].type ? "*" : ""
                            })).replace(F, "$1"), n, u < i && Se(e.slice(u, i)), i < o && Se(e = e.slice(i)), i < o && xe(e))
                        }
                        p.push(n)
                    }
                return we(p)
                    ...
                    (a = k(e, function(e, t) {
                        var n = t.length > 0
                          ...
                          , o = function(o, s, a, u, l) {
                            var f, h, y, v = 0, m = "0", x = o && [], b = [], w = c, C = o || i && r.find.TAG("*", l), S = T += null == w ? 1 : Math.random() || .1, E = C.length;
                            for (l && (c = s == d || s || l); m !== E && null != (f = C[m]); m++) {
                                if (i && f) {
                                    for (h = 0,
                            ...
                            n && m !== v) {
                                ...
                                if (o) {
                                    if (v > 0)
                                        for (; m--; )
                                            x[m] || b[m] || (b[m] = _.call(u));
                                    b = Te(b)
                                }
                                P.apply(u, b),
                                l && !o && b.length > 0 && v + t.length > 1 && ae.uniqueSort(u)
                            }
                            return l && (T = S,
                            c = w),
                            x
            ...
            u = ae.select = function(e, t, n, i) {
                var o, u, c, l, f, p = "function" == typeof e && e, d = !i && s(e = p.selector || e);
                if (n = n || [],
                1 === d.length) {
                    ...
                    for (o = V.needsContext.test(e) ? 0 : u.length; o-- && (c = u[o],
                    !r.relative[l = c.type]); )
        ...
        C.each({
            ...
            C.fn[e] = function(n, r) {
                ...
                this.length > 1 && (O[e] || C.uniqueSort(i),
                L.test(e) && i.reverse()),
                this.pushStack(i)
            }
        }
                ...
                add: function() {
                    ...
                    function t(n) {
                        C.each(n, (function(n, r) {
                            v(r) ? e.unique && c.has(r) || o.push(r) : r && r.length && "string" !== T(r) && t(r)
                        }
                        ))
                    }(arguments),
                    n && !t && u()),
                ...
                var t = [["notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2], ["resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected"]]
                  ...
                  , i = {
                    ...
                    then: function(e, r, i) {
                                ...
                                var a = this
                                  ...
                                  , c = function() {
                                    ...
                                    if (!(e < o)) {
                                        ...
                                        v(c) ? i ? c.call(n, s(o, t, M, i), s(o, t, I, i)) : (o++,
                                        c.call(n, s(o, t, M, i), s(o, t, I, i), s(o, t, M, t.notifyWith))) : (r !== M && (a = void 0,
                                        u = [n]),
                                        (i || t.resolveWith)(a, u))
                                    }
                                }
                        ...
                        return C.Deferred((function(n) {
                            t[0][3].add(s(0, n, v(i) ? i : M, n.notifyWith)),
        ...
        C.extend({
            ...
            ready: function(e) {
                ...
                !0 !== e && --C.readyWait > 0 || F.resolveWith(x, [C]))
            }
        }),
        C.ready.then = F.then,
        ...
        function ce(e, t, n, r) {
            ...
            , u = a(), c = n && n[3] || (C.cssNumber[t] ? "" : "px"), l = e.nodeType && (C.cssNumber[t] || "px" !== c && +u) && re.exec(C.css(e, t));
            if (l && l[3] !== c) {
                for (u /= 2,
                c = c || l[3],
                l = +u || 1; s--; )
        ...
        var de, he, ge = /^(?:checkbox|radio)$/i, ye = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, ve = /^$|^module$|\/(?:java|ecma)script/i;
        ...
        C.event = {
            ...
            add: function(e, t, n, r, i) {
                var o, s, a, u, c, l, f, p, d, h, g, y = J.get(e);
                if (Y(e))
            ...
            remove: function(e, t, n, r, i) {
                var o, s, a, u, c, l, f, p, d, h, g, y = J.hasData(e) && J.get(e);
                if (y && (u = y.events)) {
            ...
            dispatch: function(e) {
                var t, n, r, i, o, s, a = new Array(arguments.length), u = C.event.fix(e), c = (J.get(this, "events") || Object.create(null))[u.type] || [], l = C.event.special[u.type] || {};
                for (a[0] = u,
                t = 1; t < arguments.length; t++)
                    a[t] = arguments[t];
                if (u.delegateTarget = this,
                !l.preDispatch || !1 !== l.preDispatch.call(this, u)) {
                    for (s = C.event.handlers.call(this, u, c),
                    t = 0; (i = s[t++]) && !u.isPropagationStopped(); )
                        ...
                        n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                            ...
                            u.data = o.data,
                            void 0 !== (r = ((C.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)) && !1 === (u.result = r) && (u.preventDefault(),
                            u.stopPropagation()));
            ...
            special: {
                ...
                click: {
                    setup: function(e) {
                        var t = this || e;
                        return ge.test(t.type) && t.click && A(t, "input") && Ne(t, "click", ke),
                        !1
                    },
                    trigger: function(e) {
                        var t = this || e;
                        return ge.test(t.type) && t.click && A(t, "input") && Ne(t, "click"),
                        !0
                    },
                    _default: function(e) {
                        var t = e.target;
        ...
        C.Event = function(e, t) {
            ...
            this.type = e.type,
            this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? ke : De,
        ...
        function Ie(e, t, n, r) {
            t = u(t);
            var i, o, s, a, c, l, f = 0, p = e.length, d = p - 1, h = t[0], g = v(h);
            if (g || p > 1 && "string" == typeof h && !y.checkClone && qe.test(h))
            ...
            o || r)) {
                ...
                if (a)
                    ...
                    f = 0; f < a; f++)
                        c = s[f],
                        ve.test(c.type || "") && !J.access(c, "globalEval") && C.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? C._evalUrl && !c.noModule && C._evalUrl(c.src, {
        ...
        C.extend({
            ...
            clone: function(e, t, n) {
                var r, i, o, s, a = e.cloneNode(!0), u = se(e);
            ...
            html: function(e) {
                return z(this, (function(e) {
                    ...
                    if (void 0 === e && 1 === t.nodeType)
                        return t.innerHTML;
                    if ("string" == typeof e && !_e.test(e) && !me[(ye.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = C.htmlPrefilter(e);
                        try {
                            for (; n < r; n++)
        ...
        function Ue(e, t, n) {
            ...
            return (n = n || Fe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || se(e) || (s = C.style(e, t)),
            !y.pixelBoxStyles() && Be.test(s) && ze.test(t) && (r = a.width,
            i = a.minWidth,
            o = a.maxWidth,
        ...
        !function() {
            ...
            var r, i, o, s, a, u, c = x.createElement("div"), l = x.createElement("div");
        ...
        function nt(e, t, n, r, i, o) {
            ...
            for (; s < 4; s += 2)
                ...
                r ? ("content" === n && (u -= C.css(e, "padding" + ie[s], !0, i)),
                "margin" !== n && (u -= C.css(e, "border" + ie[s] + "Width", !0, i))) : (u += C.css(e, "padding" + ie[s], !0, i),
                "padding" !== n ? u += C.css(e, "border" + ie[s] + "Width", !0, i) : a += C.css(e, "border" + ie[s] + "Width", !0, i));
        ...
        function rt(e, t, n) {
            ...
            return (!y.boxSizingReliable() && i || !y.reliableTrDimensions() && A(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === C.css(e, "boxSizing", !1, r),
            (o = a in e) && (s = e[a])),
        ...
        C.extend({
            ...
            style: function(e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    "string" === (o = typeof n) && (i = re.exec(n)) && i[1] && (n = ce(e, t, i),
                    o = "number"),
        ...
        C.each(["height", "width"], (function(e, t) {
            C.cssHooks[t] = {
                get: function(e, n, r) {
                    if (n)
                        return !Je.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? rt(e, t, r) : $e(e, Ze, (function() {
                            return rt(e, t, r)
                        }
                        ))
                },
                set: function(e, n, r) {
                    var i, o = Fe(e), s = !y.scrollboxSize() && "absolute" === o.position, a = (s || r) && "border-box" === C.css(e, "boxSizing", !1, o), u = r ? nt(e, t, r, a, o) : 0;
                    return a && s && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - nt(e, t, "border", !1, o) - .5)),
        ...
        C.cssHooks.marginLeft = Xe(y.reliableMarginLeft, (function(e, t) {
            if (t)
                return (parseFloat(Ue(e, "marginLeft")) || e.getBoundingClientRect().left - $e(e, {
                    marginLeft: 0
                }, (function() {
        ...
        function ct() {
            st && (!1 === x.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(ct) : n.setTimeout(ct, C.fx.interval),
            C.fx.tick())
        }
        function lt() {
        ...
        function dt(e, t, n) {
            var r, i, o = 0, s = dt.prefilters.length, a = C.Deferred().always((function() {
                ...
                if (i)
                    return !1;
                for (var t = ot || lt(), n = Math.max(0, c.startTime + c.duration - t), r = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++)
                    c.tweens[o].run(r);
            ...
            for (!function(e, t) {
                ...
                if (r = dt.prefilters[o].call(c, e, l, c.opts))
                    return v(r.stop) && (C._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)),
                    r;
            return C.map(l, pt, c),
        ...
        C.Animation = C.extend(dt, {
            ...
            prefilters: [function(e, t, n) {
                var r, i, o, s, a, u, c, l, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && ue(e), y = J.get(e, "fxshow");
                ...
                if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                    ...
                    null == (c = y && y.display) && (c = J.get(e, "display")),
                    "none" === (l = C.css(e, "display")) && (c ? l = c : (pe([e], !0),
                    c = e.style.display || c,
                    l = C.css(e, "display"),
                    pe([e]))),
                    ("inline" === l || "inline-block" === l && null != c) && "none" === C.css(e, "float") && (u || (p.done((function() {
                        h.display = c
                    }
                    )),
                    null == c && (l = h.display,
        ...
        C.extend(C.event, {
            trigger: function(e, t, r, i) {
                var o, s, a, u, c, l, f, p, h = [r || x], g = d.call(e, "type") ? e.type : e, y = d.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = p = a = r = r || x,
                3 !== r.nodeType && 8 !== r.nodeType && !Tt.test(g + C.event.triggered) && (g.indexOf(".") > -1 && (y = g.split("."),
                g = y.shift(),
                y.sort()),
                c = g.indexOf(":") < 0 && "on" + g,
                ...
                i || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                    if (!i && !f.noBubble && !m(r)) {
                        ...
                        Tt.test(u + g) || (s = s.parentNode); s; s = s.parentNode)
                            h.push(s),
                            a = s;
                    ...
                    for (o = 0; (s = h[o++]) && !e.isPropagationStopped(); )
                        ...
                        (l = c && s[c]) && l.apply && Y(s) && (e.result = l.apply(s, t),
                        !1 === e.result && e.preventDefault());
                    return e.type = g,
                    i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Y(r) || c && v(r[g]) && !m(r) && ((a = r[c]) && (r[c] = null),
                    C.event.triggered = g,
        ...
        function _t(e, t, n, r) {
            ...
            if (Array.isArray(t))
                C.each(t, (function(t, i) {
                    n || Dt.test(e) ? r(e, i) : _t(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
                }
                ));
        ...
        C.extend({
            ...
            ajax: function(e, t) {
                ...
                e = void 0),
                t = t || {};
                var r, i, o, s, a, u, c, l, f, p, d = C.ajaxSetup({}, t), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? C(h) : C.event, y = C.Deferred(), v = C.Callbacks("once memory"), m = d.statusCode || {}, b = {}, w = {}, T = "canceled", S = {
                    readyState: 0,
                ...
                i = d.url.replace(Pt, ""),
                d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(qt, "+")) : (p = d.url.slice(i.length),
                d.data && (d.processData || "string" == typeof d.data) && (i += (kt.test(i) ? "&" : "?") + d.data,
                delete d.data),
                !1 === d.cache && (i = i.replace(Lt, "$1"),
                p = (kt.test(i) ? "&" : "?") + "_=" + Et.guid++ + p),
                d.url = i + p),
                d.ifModified && (C.lastModified[i] && S.setRequestHeader("If-Modified-Since", C.lastModified[i]),
                ...
                S.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : d.accepts["*"]),
                d.headers)
                ...
                function E(e, t, s, u) {
                    ...
                    f ? (d.ifModified && ((w = S.getResponseHeader("Last-Modified")) && (C.lastModified[i] = w),
                    ...
                    S.statusCode(m),
                    m = void 0,
                    l && g.trigger(f ? "ajaxSuccess" : "ajaxError", [S, d, f ? p : x]),
                    v.fireWith(h, [S, T]),
                    l && (g.trigger("ajaxComplete", [S, d]),
        ...
        y.createHTMLDocument = ((Gt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
        2 === Gt.childNodes.length),
        C.parseHTML = function(e, t, n) {
            return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
            t = !1),
            t || (y.createHTMLDocument ? ((r = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href,
            t.head.appendChild(r)) : t = x),
            o = !n && [],
            (i = N.exec(e)) ? [t.createElement(i[1])] : (i = Te([e], t, o),
...
, function(e, t, n) {
    ...
    var o = function() {
        ...
        return Object.defineProperty(e.prototype, "point", {
            get: function() {
                return this._point
            },
            set: function(e) {
                var t;
                this._point = e,
                null === (t = this._viewer) || void 0 === t || t.show()
            },
            enumerable: !1,
            configurable: !0
        }),
      ...
      , s = function() {
        function e(e, t, n) {
            ...
            this.isClock = !0;
            var i = [];
            this._shape.forEach((function(e) {
                i.push(new o({
                    x: r._centerPoint.x + e.x,
                    y: r._centerPoint.y + e.y
                },r._color))
            }
            )),
            this._squares = i
        }
        return Object.defineProperty(e.prototype, "squares", {
            get: function() {
        ...
        e.prototype.setSquarePoint = function() {
            var e = this;
            this._shape.forEach((function(t, n) {
                e._squares[n].point = {
                    x: e._centerPoint.x + t.x,
                    y: e._centerPoint.y + t.y
                }
            }
            ))
        }
        ,
        e.prototype.afterRotateShape = function() {
            return this.isClock ? this._shape.map((function(e) {
                return {
                    x: -e.y,
                    y: e.x
                }
            }
            )) : this._shape.map((function(e) {
                return {
                    x: e.y,
                    y: -e.x
                }
    ...
    function(e, t) {
        ...
        return c(t, e),
        t.prototype.afterRotateShape = function() {
            return this.shape
        }
        ,
        t
        ...
        return c(t, e),
        t
    }(s)], f = ["red", "green", "blue", "orange"];
    function p(e) {
        var t = a(0, l.length)
          , n = a(0, f.length);
        return new l[t](e,f[n])
    }
    var d = {
        width: 16,
        height: 22
    ...
    var g = function() {
        function e() {}
        return e.canIMove = function(e, t, n) {
            ...
            return !r.some((function(e) {
                return e.x < 0 || e.x > d.width - 1 || e.y < 0 || e.y > d.height - 1
            }
            )) && !r.some((function(e) {
                return n.some((function(t) {
                    return t.point.x === e.x && t.point.y === e.y
                }
                ))
            }
            ))
        ...
        e.move = function(e, t, n) {
            if (void 0 !== t.x)
                return !!this.canIMove(e.shape, t, n) && (e.centerPoint = t,
                !0);
            var i = t
              , o = void 0;
            return o = i === r.down ? {
        ...
        ,
        e.moveDirectly = function(e, t, n) {
            for (; this.move(e, t, n); )
                ;
        }
        ,
        e.rotate = function(e, t) {
            var n = e.afterRotateShape();
            return !!this.canIMove(n, e.centerPoint, t) && (e.rotate(),
            !0)
        }
        ,
        e.deleteSquares = function(e) {
            for (var t = e.map((function(e) {
                return e.point.y
            }
            )), n = Math.min.apply(Math, t), r = Math.max.apply(Math, t), i = 0, o = n; o <= r; o++)
                this.deleteLine(e, o) && i++;
            return i
        }
        ,
        e.deleteLine = function(e, t) {
            var n = e.filter((function(e) {
                return e.point.y === t
            }
            ));
            return n.length === d.width && (n.forEach((function(t) {
                var n;
                null === (n = t.viewer) || void 0 === n || n.remove(),
      ...
      , y = function() {
        ...
        return Object.defineProperty(e.prototype, "gameStatus", {
            get: function() {
        ...
        Object.defineProperty(e.prototype, "score", {
            ...
            set: function(e) {
                ...
                this._timer = void 0,
                this._duration >= 300 && (this._duration -= 100),
                this.autoDrop())
            },
            enumerable: !1,
            configurable: !0
        ...
        e.prototype.createNext = function() {
            ...
            this.resetCenterPoint(h.width, this._nextTeris)
        }
        ,
        e.prototype.init = function() {
            this._duration = 1e3,
            this._exists.forEach((function(e) {
                var t;
                null === (t = e.viewer) || void 0 === t || t.remove()
            }
            )),
            this._exists = [],
            this.createNext(),
        ...
        e.prototype.start = function() {
            this._gameStatus !== i.playing && (this._gameStatus === i.over && this.init(),
            this._gameStatus = i.playing,
        ...
        e.prototype.pause = function() {
            this._gameStatus === i.playing && (this._gameStatus = i.pause),
            clearTimeout(this._timer),
            this._timer = void 0,
            this._viewer.onGamePause()
        }
        ,
        e.prototype.controlLeft = function() {
            this._curTeris && this._gameStatus === i.playing && g.move(this._curTeris, r.left, this._exists)
        }
        ,
        e.prototype.controlRight = function() {
            this._curTeris && this._gameStatus === i.playing && g.move(this._curTeris, r.right, this._exists)
        }
        ,
        e.prototype.controlDown = function() {
            this._curTeris && this._gameStatus === i.playing && (g.moveDirectly(this._curTeris, r.down, this._exists),
            this.hitBottom())
        }
        ,
        e.prototype.controlRotate = function() {
            this._curTeris && this._gameStatus === i.playing && g.rotate(this._curTeris, this._exists)
        }
        ,
        e.prototype.switchTeris = function() {
            if (this._curTeris = this._nextTeris,
            this._curTeris.squares.forEach((function(e) {
                var t;
                null === (t = e.viewer) || void 0 === t || t.remove()
            }
            )),
            this.resetCenterPoint(h.width, this._curTeris),
            !g.canIMove(this._curTeris.shape, this._curTeris.centerPoint, this._exists))
                return console.log(123),
                this._gameStatus = i.over,
                clearTimeout(this._timer),
                this._timer = void 0,
                void this._viewer.onGameOver();
            this.createNext(),
        ...
        e.prototype.autoDrop = function() {
            var e = this;
            this._timer || this._gameStatus !== i.playing || (this._timer = setInterval((function() {
                e._curTeris && (g.move(e._curTeris, r.down, e._exists) || e.hitBottom())
            }
            ), this._duration))
        }
        ,
        e.prototype.resetCenterPoint = function(e, t) {
            var n = Math.ceil(e / 2);
            for (t.centerPoint = {
                x: n,
                y: 0
            }; t.squares.some((function(e) {
                return e.point.y < 0
            }
            )); )
                t.centerPoint = {
        ...
        ,
        e.prototype.hitBottom = function() {
            var e;
            (e = this._exists).push.apply(e, this._curTeris.squares);
            var t = g.deleteSquares(this._exists);
            t && (this.score += 100 * t),
            this.switchTeris()
        }
        ,
      ...
      , b = function() {
        ...
        return e.prototype.show = function() {
            this.isRemove || (this.dom || (this.dom = m()("<div>").css({
                position: "absolute",
                width: x.width,
                height: x.height,
            ...
            this.dom.css({
                left: this.square.point.x * x.width,
                top: this.square.point.y * x.height,
                background: this.square.color
            }))
        }
        ,
        e.prototype.remove = function() {
            this.dom && !this.isRemove && (this.dom.remove(),
            this.isRemove = !0)
        }
        ,
        e
    ...
    new y(new (function() {
        function e() {
            this.nextDom = m()("#next"),
            this.panelDom = m()("#panel"),
            this.scoreDom = m()("#score"),
            this.msgDom = m()("#msg")
        }
        return e.prototype.showNext = function(e) {
            var t = this;
            e.squares.forEach((function(e) {
                e.viewer = new b(e,t.nextDom)
            }
            ))
        }
        ,
        ...
        e.prototype.init = function(e) {
            this.nextDom.css({
                width: x.width * h.width,
                height: x.height * h.height
            }),
            this.panelDom.css({
                width: x.width * d.width,
                height: x.height * d.height
            }),
            m()(document).keydown((function(t) {
                var n = t.keyCode;
                37 === n ? e.controlLeft() : 38 === n ? e.controlRotate() : 39 === n ? e.controlRight() : 40 === n ? e.controlDown() : 32 === n && (e.gameStatus === i.playing ? e.pause() : e.start())
            }
            ))
        }
        ,
        e.prototype.showScore = function(e) {
            this.scoreDom.html(e.toString())
        }
        ,
